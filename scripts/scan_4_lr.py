"""Axis 4 launcher: learning rate, scanned last across all architecture anchors.
...
Launch with:
    torchrun --nproc_per_node=2 scripts/scan_4_lr.py   # T4x2 DDP
    python scripts/scan_4_lr.py                         # single GPU
"""
import os
import torch
